...
//16320799/1601794/2.50/2/2/Resistor

(asciiHeader
	(fileUnits MM)
)
(library Library_1
	(padStyleDef "r125_115"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 1.15) (shapeHeight 1.25))
	...
	(patternDef "ERJUP6" (originalName "ERJUP6")
		(multiLayer
			(pad (padNum 1) (padStyleRef r125_115) (pt -1.175, 0) (rotation 0))
			(pad (padNum 2) (padStyleRef r125_115) (pt 1.175, 0) (rotation 0))
		)
	...
	(symbolDef "ERJ-UP6D2401V" (originalName "ERJ-UP6D2401V")
	...
	(compDef "ERJ-UP6D2401V" (originalName "ERJ-UP6D2401V") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ERJ-UP6D2401V"))
		(attachedPattern (patternNum 1) (patternName "ERJUP6")
			(numPads 2)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "ERJ-UP6D2401V")
		(attr "Description" "Anti-Sulfurated Thick Film Chip Resistors/ Anti-Surge Type, Power Rating (W): 0.5, Chip Size (LxW(EIA)) (mm): 2.0 x 1.25 (EIA:0805), Resistance Values (?): 2400, Resistance Tolerance (%): 0.5, T.C.R (?102/K): ?100")
		(attr "<Hyperlink>" "https://industrial.panasonic.com/cdbs/www-data/pdf/RDP0000/AOA0000C337.pdf")
		(attr "<Component Height>" "0.7")
		(attr "<STEP Filename>" "ERJ-UP6D2401V.stp")
