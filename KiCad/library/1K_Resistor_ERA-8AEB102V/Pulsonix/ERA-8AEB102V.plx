...
//339873/1601794/2.50/2/2/Resistor
...
(library Library_1
	...
	(patternDef "RESC3216X70N" (originalName "RESC3216X70N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.6 0.775) (pt 1.6 0.775) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.6 0.775) (pt 1.6 -0.775) (width 0.025))
		)
	...
	(symbolDef "ERA-8AEB102V" (originalName "ERA-8AEB102V")
	...
	(compDef "ERA-8AEB102V" (originalName "ERA-8AEB102V") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ERA-8AEB102V"))
		...
		(attr "Mouser Part Number" "667-ERA-8AEB102V")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Panasonic/ERA-8AEB102V?qs=Ojoo2rCVP9R3RwZw0XjknA%3D%3D")
		(attr "Manufacturer_Name" "Panasonic")
		(attr "Manufacturer_Part_Number" "ERA-8AEB102V")
		(attr "Description" "Thin Film Resistors - SMD 1206 1.0Kohm 0.1% 25ppm")
		(attr "<Hyperlink>" "https://industrial.panasonic.com/cdbs/www-data/pdf/RDM0000/AOA0000C307.pdf")
		(attr "<Component Height>" "0.7")
		(attr "<STEP Filename>" "ERA-8AEB102V.stp")
