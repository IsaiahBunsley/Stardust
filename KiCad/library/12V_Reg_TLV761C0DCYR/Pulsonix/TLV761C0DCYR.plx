...
//20167062/1601794/2.50/4/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TLV761C0DCYR" (originalName "TLV761C0DCYR")
	...
	(compDef "TLV761C0DCYR" (originalName "TLV761C0DCYR") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "GND") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "OUT_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "IN") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "OUT_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TLV761C0DCYR"))
		...
		(attr "Mouser Part Number" "595-TLV761C0DCYR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TLV761C0DCYR?qs=VVKQmw408U888kzCkq2Yjg%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TLV761C0DCYR")
		(attr "Description" "Linear Voltage Regulators 1A 16V high-PSRR linear voltage regulator 4-SOT-223 -40 to 125")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/tlv761.pdf?ts=1680598814664&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FTLV761")
		(attr "<Component Height>" "1.8")
		(attr "<STEP Filename>" "TLV761C0DCYR.stp")
