...
(library Library_1
	...
	(compDef "TLV761C0DCYR" (originalName "TLV761C0DCYR") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "OUT_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "IN") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "OUT_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.ti.com/lit/ds/symlink/tlv761.pdf?ts=1680598814664&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FTLV761")
		(attr "Height" "1.8 mm")
	)
